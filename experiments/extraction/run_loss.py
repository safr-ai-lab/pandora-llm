...
def main():
    ...
    args.experiment_name = args.experiment_name if args.experiment_name is not None else LOSS.get_default_name(args.model_name,args.model_revision,args.num_samples,args.seed)+"_extract"
