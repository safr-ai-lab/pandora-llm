...
def main():
    ...
    parser.add_argument('--logreg_iter', action="store", type=int, required=False, default=1000,help='Number of iterations of logistic regression')
    parser.add_argument('--jl_data', action="store_true", required=False, default=False, help='Use jl data for training (T/F)')
