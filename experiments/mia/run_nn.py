...
def main():
    ...
    args.clf_path = args.clf_path if args.clf_path is not None else f"models/NN/{'_'.join(args.feature_set)}_size={args.clf_size}_N={args.clf_num_samples}_M={args.model_name.replace('/','-')}"
