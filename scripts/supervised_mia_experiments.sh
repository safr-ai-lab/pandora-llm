...
python experiments/mia/run_jl.py --model_name EleutherAI/pythia-70m-deduped --model_revision step98000 --num_samples 10 --start_index 0 --pack --seed 229 \
...
#     --clf_pos_features results/GradNorm/GradNorm_EleutherAI-pythia-70m-deduped_step98000_N=1000_S=10000_seed=229_train.pt \
#     --clf_neg_features results/GradNorm/GradNorm_EleutherAI-pythia-70m-deduped_step98000_N=1000_S=10000_seed=229_val.pt \
#     --mia_train_features results/GradNorm/GradNorm_EleutherAI-pythia-70m-deduped_step98000_N=1000_S=0_seed=229_train.pt \
#     --mia_val_features results/GradNorm/GradNorm_EleutherAI-pythia-70m-deduped_step98000_N=1000_S=0_seed=229_val.pt 
