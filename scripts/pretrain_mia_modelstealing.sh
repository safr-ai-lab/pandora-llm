...
python experiments/mia/run_modelstealing.py --model_name EleutherAI/pythia-70m-deduped --model_revision step98000 --project_type normal --num_samples 10000 --start_index 150000 --pack --seed 229
# For evaluating supervised classifier
python experiments/mia/run_modelstealing.py --model_name EleutherAI/pythia-70m-deduped --model_revision step98000 \
    --embedding_projection_file results/ModelStealing/ModelStealing_EleutherAI-pythia-70m-deduped_step98000_N=10_S=150000_seed=229/ModelStealing_EleutherAI-pythia-70m-deduped_step98000_N=10000_S=150000_seed=229_projector.pt \
