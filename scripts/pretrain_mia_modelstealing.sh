...
do
    ...
    python experiments/mia/run_logreg.py --model_name EleutherAI/pythia-${MODEL_SIZE}-deduped --model_revision step98000 --clf_num_samples 10000 --mia_num_samples 2000 --seed 229 \
        ...
        --clf_pos_features results/ModelStealing/ModelStealing_EleutherAI-pythia-${MODEL_SIZE}-deduped_step98000_N=10000_S=150000_seed=229_method=one_sided_projection/ModelStealing_EleutherAI-pythia-${MODEL_SIZE}-deduped_step98000_N=10000_S=150000_seed=229_method=one_sided_projection_train.pt \
        --clf_neg_features results/ModelStealing/ModelStealing_EleutherAI-pythia-${MODEL_SIZE}-deduped_step98000_N=10000_S=150000_seed=229_method=one_sided_projection/ModelStealing_EleutherAI-pythia-${MODEL_SIZE}-deduped_step98000_N=10000_S=150000_seed=229_method=one_sided_projection_val.pt \
        --mia_train_features results/ModelStealing/ModelStealing_EleutherAI-pythia-${MODEL_SIZE}-deduped_step98000_N=2000_S=0_seed=229_method=one_sided_projection/ModelStealing_EleutherAI-pythia-${MODEL_SIZE}-deduped_step98000_N=2000_S=0_seed=229_method=one_sided_projection_train.pt \
        --mia_val_features results/ModelStealing/ModelStealing_EleutherAI-pythia-${MODEL_SIZE}-deduped_step98000_N=2000_S=0_seed=229_method=one_sided_projection/ModelStealing_EleutherAI-pythia-${MODEL_SIZE}-deduped_step98000_N=2000_S=0_seed=229_method=one_sided_projection_val.pt
