...
# Generate a list with all indices, then shuffle them
indices = torch.randperm(lengths)

# Split the indices for training and validation
train_indices = indices[:lengths // 2]
val_indices = indices[lengths // 2:]
...
valloader = torch.utils.data.DataLoader(
    val_dataset, batch_size=128, shuffle=True, num_workers=2)
