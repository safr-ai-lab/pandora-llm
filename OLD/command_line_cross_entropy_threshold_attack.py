...
# %%
model_title = sys.argv[1]
bs = int(sys.argv[2]) ## batch size
nbatches = int(sys.argv[3]) ## Number of batches to gather data on. Number of data points is bs * nbatches
samplelength = int(sys.argv[4]) ## How long are the sequences we take from the training and validation sets.
